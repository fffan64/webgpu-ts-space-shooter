...
export class BloomBlurEffect {
  ...
  public draw(
    textureToApplyTo: GPUTextureView,
    textureToApplyToBindGroup: GPUBindGroup
  ) {
    // HORIZONTAL PASS
    ...
    horizontalPassEncoder.setBindGroup(0, textureToApplyToBindGroup);
